...
class GradientBugController:
    ...
    def stateMachine(self,RRT,odometry):   
        ...
        diff_range = (self.current_range-self.last_range)/100.0
        self.diff_diff_range = self.last_range_diff-diff_range;
        
        print self.diff_diff_range
        print diff_range
...
#                     twist = self.WF.twistTurnAroundCorner(self.distance_to_wall+0.2,self.direction)
       ...
       #self.cmdVelPub.publish(twist)
        ...
        self.last_range_diff = deepcopy(diff_range)
