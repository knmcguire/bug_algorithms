...
rosinit
with_plot = false;
bug_names = {'wf', 'com_bug', 'bug_2','alg_1', 'alg_2', 'i_bug', 'blind_bug','gradient_bug'};
...
gen_env_serv = rossvcclient('/indoor_gen');
...
for itk = 1:amount_of_environments
    disp(itk)
    msg_env.Data = 1;
    testreq = rosmessage(gen_env_serv);

    call(gen_env_serv,testreq,'Timeout',3)
    keyboard
